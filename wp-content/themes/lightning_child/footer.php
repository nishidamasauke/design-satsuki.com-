...
<h2 class="contact-title"><img src="<?php echo get_template_directory_uri(); ?>/images/contact_h2.png" alt="お問い合わせ"></h2>
<p class="con-text">まずは、あなたの気持ちをお聞かせください。</p>
<div class="contact_button">
<a href="/contact/" class="btn-square"><i class="fa fa-envelope" aria-hidden="true"></i>
お問い合わせ</a>
</div>
</div>
</section>
